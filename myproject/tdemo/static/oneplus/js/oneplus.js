...
$('.pdd2 li').mouseover(function(){
	var a = $(this).val()
	if (a==1) {
		$('#dss').attr('src','./static/oneplus/images/fdb_hover.png')
	}if (a==2) {
		$('#dgwc').attr('src','./static/oneplus/images/shopb.png')
	}if (a==3) {
		$('#dp').attr('src','./static/oneplus/images/icon_person_hover.png')
	}
})
$('.pdd2 li').mouseout(function(){
	var a = $(this).val()
	if (a==1) {
		$('#dss').attr('src','./static/oneplus/images/fdb.png')
	}if (a==2) {
		$('#dgwc').attr('src','./static/oneplus/images/shopw.png')
	}if (a==3) {
		$('#dp').attr('src','./static/oneplus/images/icon_person.png')
	}
})
...
$('.yyhxz ul li').click(function(){
	...
	if (a == 1) {
		...
		$('.yyhimg img').attr('src','./static/oneplus/images/gray-phone.png')
	...
	if (a == 2) {
		...
		$('.yyhimg img').attr('src','./static/oneplus/images/black-phone.png')
	...
	if (a == 3) {
		...
		$('.yyhimg img').attr('src','./static/oneplus/images/Unknown.png')
...
$('.bukeneng li').mouseover(function(){
	...
	if (a == 1) {
		$('#a1').attr('src','./static/oneplus/images/shoujic.png')
	}
	if (a == 2) {
		$('#a2').attr('src','./static/oneplus/images/erjic.png')
	}
	if (a == 3) {
		$('#a3').attr('src','./static/oneplus/images/kec.png')
	}
	if (a == 4) {
		$('#a4').attr('src','./static/oneplus/images/xianc.png')
	}
	if (a == 5) {
		$('#a5').attr('src','./static/oneplus/images/taozhuangc.png')
	}
	if (a == 6) {
		$('#a6').attr('src','./static/oneplus/images/baoc.png')
	}
})
$('.bukeneng li').mouseout(function(){
	...
	if (a == 1) {
		$('#a1').attr('src','./static/oneplus/images/shoujib.png')
	}
	if (a == 2) {
		$('#a2').attr('src','./static/oneplus/images/erjib.png')
	}
	if (a == 3) {
		$('#a3').attr('src','./static/oneplus/images/keb.png')
	}
	if (a == 4) {
		$('#a4').attr('src','./static/oneplus/images/xianb.png')
	}
	if (a == 5) {
		$('#a5').attr('src','./static/oneplus/images/taozhuangb.png')
	}
	if (a == 6) {
		$('#a6').attr('src','./static/oneplus/images/baob.png')
	}
})
//不可能的固定
// $(window).scroll(function(){
